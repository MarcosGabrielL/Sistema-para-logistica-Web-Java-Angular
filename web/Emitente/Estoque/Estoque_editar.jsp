		...
		<div style="padding: 0; padding-left: 60px; float: left; width: 25%; display: inline-block; padding-bottom: 15px;" class="wrap-contact100">
			<span style="  color: #333333;  padding-bottom: 6px; text-align: left; " class="contact100-form-title">
                    ...
                    <li style="margin-top: 0;">
                        <label>Novo Tipo <span class="required"></span></label>
                        ...
                        <input class="contact100-form-btn" style="color: #ffffff;
                                               ...
                                               " type="submit" value="Adicionar Tipo">
                    </li>
                    </ul>
                </div>
                    <!-- Tabela -->
            <div style=" padding: 0px 40px 0px 60px; border: 0; float: left; width: 50%; display: inline-block;" class="wrap-contact100">
            ...
            <div style="border-radius: 13px; border-style: solid; border-width: 2px; background: #fff;
                 background: #fff; margin-bottom: 20px; overflow: auto; width: 100%; height: 90%; min-height: 400px;" class="validate-input bg1 rs1-wrap-input50">
		<table>
                <thead>
                  <tr>
                    <th>TIPO</th>
            ...
            <input class="contact100-form-btn" style="color: #ffffff;
                                               cursor: pointer !important; margin-top: 10px;
                                               " type="submit" value="Remover Tipo">
