      ...
      <li><a href="../Estoque/Retornada.jsp" >Retornada</a></li>
			...
			<span style="  color: #333333;  padding-bottom: 6px; text-align: left; " class="contact100-form-title">
					Relatórios
                        ...
                        <input class="field-divided" title="Próximo relatório" style="position: absolute; height: 35px; width: 9%; color: #ffffff; 
                                                               background: #fff; 
                                                               background-image: url(../resources/imagens/forward.png); 
                                                               cursor: pointer !important; background-position:center;
                                                               background-repeat:no-repeat;margin-left: 85%; margin-top: -50px; " 
                                                               type="button" onclick="alert('Proximo Relatorio!')" value="">
		...
		<div style=" padding: 0; padding-left: 60px; float: left; width: 25%; display: inline-block; padding-bottom: 7px;" class="wrap-contact100">
                ...
                <form>
                <ul class="form-style-1">
                    <li><label>Filtros <span class="required"></span></label>
                        <select name="field4" class="field-select">
                        <option value="Partnership">Abaixo de X Vendidos</option>
                        <option value="General Question">Abaixo de X% referente ao dia anterior</option>
                        <option value="General Question">Abaixo de X% referente ao dia Y</option>
                        </select>
                    ...
                    <div id="1">
                            <ul class="form-style-1">
                                <li><label>Vendas Abaixo de <span class="required"></span></label>
                                    <input type="text" name="field1" class="field-long" placeholder="" value="10" /> 
                                </li>
                            </ul>
                        </div>
                        <div id="2" style="display:none;">
                            <ul class="form-style-1">
                                <li><label>Percentual abaixo referente ao dia anterior (%) <span class="required"></span></label>
                                    <input type="text" name="field1" class="field-long" placeholder="" /> 
                                </li>
                            </ul>
                        </div>
                        <div id="3" style="display:none;"> <!-- style="display:none;" -->
                            <ul class="form-style-1">
                                <label>Percentual abaixo (%) <span class="required"></span></label>
                                    <input type="text" name="field1" class="field-long" placeholder="" /> 
                                <label>referente ao dia <span class="required"></span></label>
                                    <input type="text" name="field1" class="field-long" placeholder="" /> 
                    ...
                    <!-- Tabela -->
            <div style=" padding: 0px 20px 0px 40px; border: 0; float: left; width: 75%; display: inline-block;" class="wrap-contact100">
            ...
            <div style="border-radius: 13px; border-style: solid; border-width: 2px; background: #fff;
                 background: #fff; overflow: auto; width: 100%; height: 90%; min-height: 95%;" class="validate-input bg1 rs1-wrap-input50">
		<table>
                <thead>
                  <tr>
                    <th>Item</th>
