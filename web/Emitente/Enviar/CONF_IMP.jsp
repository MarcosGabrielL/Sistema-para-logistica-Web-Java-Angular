   ...
   <ul>
     ...
     <ul>
		...
		<span style="padding-left: 10px;  color: #333333;  padding-bottom: 6px; text-align: left; " class="contact100-form-title">
		     ...
		     <ul class="form-style-1">
                    <li style="margin-top: 0;">
                        <label>Caixa <span class="required"></span></label>
                        <select name="field4" class="field-select">
                           <option>--</option>
                                                        <option>1</option>
                                                        <option>2</option>
                    ...
                    <div style="padding: 0; padding-bottom: 6px; padding-left: 10px;  float: left; width: 100%; display: inline-block;" class="wrap-contact100">
		     <ul class="form-style-1">
                    <li style="margin-top: 0;">
		...
		<span style="padding-left: 20px;  color: #333333;  padding-bottom: 6px; text-align: left; " class="contact100-form-title">
                ...
                <div style="padding: 0; padding-left: 10px; float: left; width: 50%; display: inline-block;" class="wrap-contact100">
                    ...
                    <li style="margin-top: 0;">
                        ...
                        <select name="field4" class="field-select">
                           <option>--</option>
                                                        ...
                                                        <option>EPSON</option>
                                                        <option>DARUMA</option>
                                                        <option>Outros</option>
                        </select>
                        <label>Selecione a impressora cupom fiscal <span class="required"></span></label>
                        <select name="field4" class="field-select">
                        <option>--</option>
                                                        </select>
                        <span style="padding-left: 10px;  color: #333333;  padding-bottom: 6px; text-align: left; " class="contact100-form-title">
					&nbsp;&nbsp;&nbsp;
                        ...
                        <span style=" color: #ea5c1a; font-size: 20px; padding-bottom: 6px; text-align: left; " class="contact100-form-title">
					Impressora para orçamento
				</span>
                        <ul class="form-style-1">
                    <li style="margin-top: 0;">
                        	<label>Selecione a impressora Orçamento <span class="required"></span></label>
                        <select name="field4" class="field-select">
                        <option>--</option>
                                                        </select>
                                <div style=" padding-top: 0; width: 100%; " class="container-contact100-form-btn">
					<input class="contact100-form-btn" style="color: #ffffff;
                                               cursor: pointer !important; margin-top: 20px;
		     ...
		     <ul class="form-style-1">
                    <li style="margin-top: 0;">
                        ...
                        <select name="field4" class="field-select">
                        <option>--</option>
                                                        <option>MP - 4200</option>
                                                        <option>MP - 5100</option>
                                                        <option>MP - 100S</option>
                                                        <option>MP - 2032</option>
                                                        <option>MP - 2500</option>
                                                        <option>MP - 4000</option>
                                                        <option>Outros</option>
                                                        </select>
