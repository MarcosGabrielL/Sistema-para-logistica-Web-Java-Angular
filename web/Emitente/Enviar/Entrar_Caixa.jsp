 ...
 %>
            <!-- AREA DE AÇÃO -->
					...
					Seu Caixa está aberto. Deseja fecha-lo?
                          ...
                          <form id="form-id" class="login-form" action="Enviar/Controller/Fechar_controller.jsp" method="POST">
                          </form>
                          <form id="formentrar" class="login-form" action="Enviar/Controller/Entrar_controller.jsp" method="POST">
                              </form>
                          </div>
                      </div>  
            ...
            <!-- AREA DE AÇÃO -->
					...
					O que deseja fazer?
                        ...
                        <div id="log" style="display: none;" class="login-page">
                            <form class="login-form" action="Enviar/Controller/Sign_in_controller.jsp" method="POST">
