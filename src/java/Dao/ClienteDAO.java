...
public class ClienteDAO {
  ...
  try {
   ps = connection.prepareStatement("INSERT INTO data_gibgas.cliente "
   ...
   ps.setString(21, obj_User.getCpf());
 ...
 return flag;
  ...
  DB_Connection obj_DB_Connection = new DB_Connection();
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM data_gibgas.cliente where email = ?");
 ...
 return flag;
  ...
  DB_Connection obj_DB_Connection = new DB_Connection();
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM data_gibgas.cliente where user = ?");
            stmt.setString(1, email);
            rs = stmt.executeQuery();
