...
public class ProdutoDAO {
  ...
  ResultSet rs=null;
        ...
        try {
            stmt = con.prepareStatement("INSERT INTO produtos (codigo,descrição,quantidade,tipo,preçoun,"
                    ...
                    + "ventrada,afederaln,afederali,aestadual,amunicipal,modbcst) "
                    + "VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
            ...
            stmt.setString(48, p.getModBCST());
            stmt.executeUpdate();
    ...
    public List<Produto> read(){
        ...
        try {
            ...
            while(rs.next()){
                ...
                produto.setModBCST(rs.getString("modbcst"));
    ...
    PreparedStatement stmt = null;
        ...
        try {
            stmt = con.prepareStatement("UPDATE nossocliente.produtos SET descrição = ? ,"
                    ...
                    + "ventrada = ?, afederaln = ?, afederali = ?, aestadual = ?, amunicipal = ?, modbcst = ? WHERE codigo = ?");
            ...
            stmt.setString(47, p.getModBCST());
            stmt.setString(48,p.getCodigo());
    ...
    public List<Produto> readdesc(String desc){
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM produtos WHERE codigo LIKE ?");
            ...
            while(rs.next()){
                ...
                produto.setQuantidade(rs.getFloat("quantidade"));
                produto.setTipo(rs.getString("tipo"));
                produto.setPrecoun(rs.getString("preçoun"));
                produto.setUnidade(rs.getString("unidade"));
                produto.setLoja(rs.getString("loja"));
                produto.setData(rs.getString("dataentrada"));
                produto.setValidade(rs.getString("validade"));
 ...
 // TODO: handle exception
    ...
    public List<Produto> Procurar(String descrição){
       ...
       DB_Connection obj_DB_Connection = new DB_Connection();
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM produtos WHERE descrição LIKE ?");
 ...
 // TODO: handle exception
  ...
  ResultSet rs=null;
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM PRODUTOS order by codigo");
            rs = stmt.executeQuery();
     ...
     public List<Produto> TipoOrdenado(String tipo){
